...
"""
When I initialise with a tile and contents
...
def test_count_words_returns_word_count_of_contents():
    diary_entry = DiaryEntry("My Title", "one two theww four five")
    assert diary_entry.count_words() == 5

"""
When I initilise with a five-word contents 
then #read_time with a wpm of 2 should return 3
"""
...
"""
When I initialise with a five-word contents
Then, on the second call, #reading_chuck should return the second chunk
    readable in the time
"""
...
"""
When I initialise with a five-word contents
Then, on the third call, #reading_chuck should return the final partial chunk
"""
...
"""
When I initialise Iwith a five-words contents
